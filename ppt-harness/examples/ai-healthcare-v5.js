...
const out = path.join(__dirname, 'output', 'ai-healthcare-v5.pptx');
...
const slides = [
  ...
  },
  {
    ...
    sub: '三个方向，重塑医疗的下一个十年。',
    cards: [
      { icon: 'lu/LuSparkles', title: '医疗大模型', desc: '多模态通用医学智能一次训练即可多场景复用，把专科 AI 的落地成本从重复造轮子降到一次打通，成为医院与药企的新底座。', img: 'artificial intelligence neural network' },
      { icon: 'lu/LuBot', title: 'AI 医生伙伴', desc: '从单点辅助走向覆盖诊前分诊、诊中决策、诊后随访的全流程协作伙伴，让医生把时间还给患者。', img: 'robot medical assistant doctor' },
      { icon: 'lu/LuAtom', title: 'AI × 生命科学', desc: '与蛋白质设计、基因编辑、高通量筛选深度融合，把新药发现从"大海捞针"变成"按图索骥"，重构生命科研范式。', img: 'dna molecule biology science' },
    ],
  },
  {
    t: 'closing',
