// v3: showcase harness enhancements — fuller text (sub/lead/longer desc), more images
// (cover + divider + side-images on iconGrid & quadrant + twoCol), beautified chart + beautified table.
// Run: node examples/ai-healthcare-v3.js

const path = require('path');
const { build } = require('../harness');
const out = path.join(__dirname, 'output', 'ai-healthcare-v3.pptx');
...
const slides = [
  {
    ...
    intro: '从医学影像到药物研发，从精准医疗到健康管理，人工智能正在重塑诊疗的每一个环节。',
    img: 'medical artificial intelligence technology doctor',
  ...
  },
  {
    ...
    items: [
      { title: '行业背景与关键数字', desc: '市场规模、效率提升与渗透率全景' },
      { title: '六大核心应用场景', desc: '从影像、研发到健康管理的完整版图' },
      { title: '医学影像 × 计算机视觉', desc: 'AI 的主战场与准确率表现' },
  ...
  },
  {
    ...
    subtitle: 'AI 渗透医疗的全流程——从筛查、诊断，到研发与管理。',
    img: 'doctor artificial intelligence hospital tablet',
    points: ['影像与病理', '研发与精准', '管理与随访'],
  },
  {
    t: 'iconGrid', eyebrow: '03 · 应用', title: '六大核心应用场景',
    sub: 'AI 在医疗的六个主力场景，覆盖诊前、诊中与诊后。',
    cards: [
      { icon: 'lu/LuScanLine', title: '医学影像', desc: 'X 光 / CT / MRI / 病理自动识别与量化测量', img: 'x ray ct scan medical imaging' },
  ...
  },
  {
    ...
    lead: 'AI 通过深度学习自动识别影像中的异常征象，承担检出、分割、量化与排序工作，显著降低漏诊。',
  ...
  },
  {
    ...
    left: {
      title: '从检出到决策支持',
      lead: 'AI 自动完成检出、分割、量化与优先级排序，把医生从海量读片中解放出来，聚焦最需要判断的病例。',
  ...
  },
  {
    ...
    img: 'medical data security privacy shield',
    cards: [
      { icon: 'lu/LuLock', title: '数据隐私', desc: '患者数据高度敏感，需脱敏、授权与安全治理' },
      { icon: 'lu/LuScale', title: '算法公平', desc: '训练偏倚导致跨人群、跨机构性能不一' },
      { icon: 'lu/LuEye', title: '可解释性', desc: '黑箱决策影响医生信任与临床采纳' },
      { icon: 'lu/LuShieldCheck', title: '监管合规', desc: '准入标准、临床路径与责任归属待完善' },
    ],
  },
  {
    t: 'future', eyebrow: '08 · 展望', title: '未来三大趋势',
    sub: '三个方向，重塑医疗的下一个十年。',
    lead: '从专用模型到通用智能，从单点辅助到全程协作，AI 与生命科学的融合正在加速。',
    cards: [
      { icon: 'lu/LuSparkles', title: '医疗大模型', desc: '多模态通用医学智能，一次训练、多场景复用，大幅降低落地成本。' },
      { icon: 'lu/LuBot', title: 'AI 医生伙伴', desc: '从单点辅助走向覆盖诊前、诊中、诊后的全流程诊疗协作。' },
      { icon: 'lu/LuAtom', title: 'AI × 生命科学', desc: '与蛋白质设计、基因编辑、新药发现深度融合，重构科研范式。' },
    ],
  },
  {
    t: 'closing',
